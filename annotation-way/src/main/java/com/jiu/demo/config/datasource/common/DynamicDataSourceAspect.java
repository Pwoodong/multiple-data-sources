...
public class DynamicDataSourceAspect {
    ...
    @Pointcut("execution(* com.jiu.demo.service.*.list*(..))")
    ...
    public void doBefore(JoinPoint joinPoint, TargetDataSource targetDataSource) {
        ...
        if (dataSourceKey == DataSourceKey.DB_ORACLE) {
            log.info(String.format("设置数据源为  %s", DataSourceKey.DB_ORACLE));
            DynamicDataSourceContextHolder.set(DataSourceKey.DB_ORACLE);
        } else {
